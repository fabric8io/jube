...
First you need to [download jube-2.0.19-image.zip](http://central.maven.org/maven2/io/fabric8/jube/images/jube/jube/2.0.19/jube-2.0.19-image.zip) and unzip it:
