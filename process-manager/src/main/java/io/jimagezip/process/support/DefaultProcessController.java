 ...
 */
package io.jimagezip.process.support;
...
import io.jimagezip.process.support.command.CommandFailedException;
...
/**
 * A default implementation of {@link io.jimagezip.process.ProcessController} which assumes a launch script which
...
public class DefaultProcessController implements ProcessController {
     ...
     * (assigned by the {@link io.jimagezip.process.service.ProcessManagerService}).
     */
